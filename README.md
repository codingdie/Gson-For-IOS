...
不用其它开源库的原因：两年前那些库都写的烂，然后api设计不符合我的习惯，现在好一点了  
...
ClassRoom * classRoom=[Gson fromJsonStr:objectWithArrayAndObject toModel:[ClassRoomNSString* objectJsonStr=@"{\"studentId\":2,\"studentName\":\"8班2号学生\"}";
Student * student=[Gson fromJsonStr:objectJsonStr toModel:[Student class]];
...
NSLog(@"%@",[Gson toJson:classRooms]); class]];
